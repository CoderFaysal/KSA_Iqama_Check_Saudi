...
public class IqamaCheck extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.iqama_check);



        ActionBar actionBar = getSupportActionBar();
        assert actionBar != null;
        actionBar.setTitle("Saudi Arabia Iqama Check");
        ...
        webView = new WebView(IqamaCheck.this);
        ...
        if(!isNetworkAvailable(IqamaCheck.this)){
